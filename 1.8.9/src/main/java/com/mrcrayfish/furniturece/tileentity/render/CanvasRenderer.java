...
{
	private EntityPainting painting = new EntityPainting(Minecraft.getMinecraft().theWorld);
	...
	public void renderTileEntityAt(TileEntity tileEntity, double posX, double posY, double posZ, float partialTick, int breakStage) 
	{
		...
		GlStateManager.pushMatrix();
		{
			...
			Minecraft.getMinecraft().getRenderManager().renderEntityWithPosYaw(painting, 0, 0, 0, 0, 0);
		}
