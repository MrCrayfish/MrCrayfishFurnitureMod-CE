...
public class GuiModelInfo extends GuiScreen 
{
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks)
	{
		...
		GlStateManager.pushMatrix();
		{
			...
			{
				model = dispatcher.getModelFromBlockState(block.getDefaultState(), mc.theWorld, (BlockPos) null);
			} 
			dispatcher.getBlockModelRenderer().renderModel(mc.theWorld, model, block.getDefaultState(), pos, renderer, false);
