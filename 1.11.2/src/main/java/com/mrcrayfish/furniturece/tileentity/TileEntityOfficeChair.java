...
public class TileEntityOfficeChair extends TileEntity
{
	...
	public void removeSeat()
	{
		...
		{
			hasTop = false;
			world.scheduleUpdate(pos, FurnitureBlocks.office_chair, 1);
		}
	}
	...
	{
		List<EntitySittableBlock> sittableBlocks = world.getEntitiesWithinAABB(EntitySittableBlock.class, new AxisAlignedBB(pos.getX(), pos.getY(), pos.getZ(), pos.getX() + 1.0D, pos.getY() + 1.0D, pos.getZ() + 1.0D));
